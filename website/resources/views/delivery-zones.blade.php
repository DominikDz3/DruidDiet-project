...
<div class="container my-5">
    ...
    <div class="row mt-4">
        <div class="col-12">
            <div class="card shadow-sm"> {{-- Karta otrzyma style z nordic.css --}}
                <div class="card-body">
                    {{-- Zmieniono styl inline na klasę .map-placeholder-wrapper, zachowując style wymiarów --}}
                    <div class="map-placeholder-wrapper" style="width: 100%; height: 450px; display: flex; align-items: center; justify-content: center;">
