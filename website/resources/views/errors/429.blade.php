        ...
        <div class="row justify-content-center">
            <div class="col-md-8 text-center">
                <div class="alert alert-danger" role="alert">
                    <h1><i class="bi bi-exclamation-triangle-fill me-2"></i>Błąd 429</h1>
                    <h1>Zbyt wiele żądań</h1>
                    <p class="mb-0">Przepraszamy, wysłałeś zbyt wiele żądań w krótkim czasie.</p>
